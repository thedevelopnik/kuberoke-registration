...
export const generateInterface = (interfaceName, fields) => {
    ...
    const contents = sortedFields
        .map(({ fieldName, fieldType, comment, optional }) => (comment ? `  /** ${escapeComment(comment)} */\n` : '') +
...
export function generateDeclarationFile(contents, fileName, connection, mode, config, decsFileName) {
    return __awaiter(this, void 0, void 0, function* () {
